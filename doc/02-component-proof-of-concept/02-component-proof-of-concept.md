...
I think the alphabet soup idea is the best, since it is most representative of a data structure, and is similar to some of the other data structures in the OSU components. It's the easiest to represent and implement, which will be good for me since I don't want to spend a ton of time on this.
